...
class ImageUploadsControllerTest < ActionController::TestCase
  ...
  test "should create image_upload" do
    assert_difference('ImageUpload.count') do
      post :create, image_upload: { filename: @image_upload.filename, timestamp: @image_upload.timestamp, user_id: @image_upload.user_id }
    end
  ...
  test "should update image_upload" do
    patch :update, id: @image_upload, image_upload: { filename: @image_upload.filename, timestamp: @image_upload.timestamp, user_id: @image_upload.user_id }
    assert_redirected_to image_upload_path(assigns(:image_upload))
  end
